...
Es un gestor de contenidos web (Content Manager System -CMS-). Especialmente dirigido a:
...
Són cadenas de carácteres con un formato que identifica recursos indicando su dirección electrónica
