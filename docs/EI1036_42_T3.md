...
```html
<p> El <span style="background:#ffeebb";> SPAN </span> 
por defecto es inline. 
<span style="display:inline-block;border:solid;background:#ffeebb;"> 
Span que  ya no es inline, es block.</span></p>
<p style="display:inline-block;border:solid;background:#ffeebb;"> Ahora este párrafo no es block</p>
