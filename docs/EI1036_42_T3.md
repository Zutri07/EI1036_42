...
<p id="gira" >Esto hace algo al pulsar
<a href="#"> Acción CSS3Transform</a>
Se ve o no se ve.</p> 
```
...
<a style="display:block; border:solid 4px rgb(204,0,0);"
href="aqui" .class="enlace"> Hiperenlace que  ya no es inline, es block.</a>
<p>Hiperenlace <a href="alli".class="enlace 
style="display:inline-block; border:solid 4px rgb(204,0,0);background:#ffeebb;">
Alli</a> ,que es una caja inline, no es block</p>
```


<p> Esto es un párrafo, elemento block por defecto que contiene un trozo de texto <span> SPAN </span> que por defecto es inline. 
<span href="aqui" style="display:inline-block;border: solid 4px rgb(204, 0, 0) ; background : #ffeebb ; "> 
